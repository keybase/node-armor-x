...
(function() {
  ...
  exports.StreamEncoder = StreamEncoder = (function(_super) {
    ...
    function StreamEncoder(encoder) {
      ...
      StreamEncoder.__super__.constructor.call(this, f, this.encoder.in_block_len, false, {
  ...
  exports.StreamDecoder = StreamDecoder = (function(_super) {
    ...
    function StreamDecoder(decoder) {
      ...
      StreamDecoder.__super__.constructor.call(this, f, this.decoder.out_block_len, false, {
        writableObjectMode: false,
        readableObjectMode: false
      });
    }
