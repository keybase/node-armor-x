...
(function() {
  ...
  exports.StreamEncoder = StreamEncoder = (function(_super) {
    ...
    function StreamEncoder(encoder) {
      ...
      StreamEncoder.__super__.constructor.call(this, {
        highWaterMark: calculate_high_water_mark(this.block_size)
      });
    }
    ...
    StreamEncoder.prototype._flush = function(cb) {
      if (this.extra) {
        this.push(this.encoder.encode(this.extra));
      }
      return cb();
    };
  ...
  exports.StreamDecoder = StreamDecoder = (function(_super) {
    ...
    StreamDecoder.prototype._flush = function(cb) {
      if (this.extra) {
        this.push(this.decoder.decode(this.extra));
      }
      return cb();
    };
