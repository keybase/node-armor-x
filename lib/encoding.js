...
(function() {
  ...
  exports.Encoding = Encoding = (function() {
    ...
    Encoding.prototype.decode_block = function(src) {
      var c, consumed, d, i, pad, padlen, res, ret, src_p, _i, _len;
      res = nbv(0);
      consumed = 0;
      ...
      ret = consumed === 0 ? new Buffer([]) : (res = new Buffer(res.toByteArray()), padlen = this.decoded_len(consumed) - res.length, pad = new Buffer((function() {
        var _j, _results;
        _results = [];
